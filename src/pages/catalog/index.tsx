...
import Favouritess from "../../img/Favourites.svg";
        ...
        <div className="mx-auto mt-4 max-w-[1180px] min-h-[511px] rounded px-5 py-[30px]">
          ...
          <ul className="grid grid-cols-4 max-[1024px]:grid-cols-3 max-[768px]:grid-cols-2 max-[500px]:grid-cols-1 ">
            {allPosts?.map((item) => (
              <li
                key={item.id}
                className="border-basic mx-2 justify-self-center mb-4 flex min-h-[370px]  max-w-[285px]
                 max-[500px]:min-w-full flex-col items-center justify-between rounded border-[1px] 
                 border-solid bg-white p-4 pb-2 text-center"
              >
                ...
                <div className="mt-6 flex w-full justify-between">
                  ...
                  <div className="flex gap-6">
                    ...
                    <Image src={Favouritess} className="active:border-red-600 border-solid active:p-1" alt="избранное"/>
                  </button>
                  </div>
                </div>
              </li>
