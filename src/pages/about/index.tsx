...
export default function About() {
  return (
    <Layout  className='font-basic'>
      <div>
        <div className='flex overflow-clip max-[840px]:h-[700px] max-[740px]:h-[500px] justify-center
         items-center flex-col text-base font-basic  bg-[url("../img/start.png")] h-[900px] object-cover bg-no-repeat bg-cover text-center'>
            ...
            <p className='font-basic z-[35] p-10 max-w-[600px] text-4xl max-[1132px]:text-4xl max-[840px]:text-3xl max-[740px]:text-2xl max-[604px]:text-xl'>
              Nano - онлайн магазин бытовых товаров известных брендов в России</p>
    ...
    '>
      ...
      <div>
      <p className='font-basic max-w-[600px] p-5 max-[1182px]:text-3xl max-[840px]:text-2xl max-[800px]:text-xl max-[720px]:text-lg max-[6x20px]:text-lg'>
        Все заказы обрабатываются в течение нескольких часов. если диспетчер подтвердил вам заказ - это гарантия того, что заказ будет доставлен..</p>
      </div>
    ...
    '>
      ...
      <div>
      <p className='font-basic max-[1182px]:text-4xl p-10  max-[840px]:text-3xl max-[740px]:text-2xl max-[604px]:text-xl'>
        Постоянное наличие широкого ассортимента техники на наших складах, поэтому доставка может быть выполнена уже на следующий день после оформления вами заказа.</p>
      </div>
