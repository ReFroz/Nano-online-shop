  ...
  return (
    <div className="mx-auto max-w-[1180px] px-5">
      <div className="grid grid-cols-2 gap-[42px] font-basic max-[1024px]:grid-cols-1 ">
            ...
            >
              {filterPost?.map((item)=>(
               <swiper-slide key={item.id} >
                <div className="flex px-8 p-5 justify-around">
        ...
        <div className="flex flex-col items-center rounded-lg border-[1px] border-solid border-base py-6 text-center shadow-xl shadow-base min-[1024px]:max-w-full">
          <p className="text-3xl">Товары дня</p>
          <hr className="my-2 h-[7px] w-[300px] rounded bg-base" />
          <div className="w-full">
            <swiper-container
...
const FeedbackForm=()=>{
  ...
  <div className="max-w-[1180px]  items-center  mx-auto font-basic text-xl p-5">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col justify-center items-center max-[1140px]:justify-normal max-[1140px]:items-stretch">
        <div  className="grid grid-cols-2 gap-[30px] max-[1140px]:grid-cols-1" >
        <div className="flex flex-col justify-between gap-[30px]">
          ...
          <Image alt="Обратная связь" src={Feedback} className="max-[1140px]:hidden"/>
        </div>
        <input className='max-[1140px]:w-full my-5 px-2 py-3 rounded border-solid border-black border-2' type='submit'/>
      </form>
...
const PolularCategory=()=>{
  ...
  <div className="mx-auto max-w-[1180px] p-5">
        ...
        <hr className="my-2 h-[7px] w-[300px] rounded bg-base" />
    <div className="grid  gap-5 grid-cols-3 content-between justify-between max-[960px]:grid-cols-2 max-[640px]:grid-cols-1">
